...
public class PlayerHud : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        {
            GUI.DrawTexture(new Rect(30, 30, 70, 70), heart);
            GUI.DrawTexture(new Rect(100, 30, 70, 70), heart);
            GUI.DrawTexture(new Rect(170, 30, 70, 70), heart);
        }
        else if (playerController.GetHealth() == 5)
        {
            GUI.DrawTexture(new Rect(30, 30, 70, 70), heart);
            GUI.DrawTexture(new Rect(100, 30, 70, 70), heart);
            GUI.DrawTexture(new Rect(170, 30, 70, 70), halfHeart);
        }
        ...
        {
            GUI.DrawTexture(new Rect(30, 30, 70, 70), heart);
            GUI.DrawTexture(new Rect(100, 30, 70, 70), halfHeart);
        }
        ...
        {
            GUI.DrawTexture(new Rect(30, 30, 70, 70), halfHeart);
        }
    }
}
